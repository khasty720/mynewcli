...
running command...
$ mynewcli (--version)
mynewcli/0.0.0 darwin-arm64 node-v18.3.0
...
_See code: [dist/commands/hello/index.ts](https://github.com/Sandbox/hello-world/blob/v0.0.0/dist/commands/hello/index.ts)_
